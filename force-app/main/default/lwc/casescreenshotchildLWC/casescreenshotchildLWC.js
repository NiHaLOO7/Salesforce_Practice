...
export default class CasescreenshotchildLWC extends NavigationMixin(LightningElement) 
{
    @track cols=[
        ...
        */
        { label: 'Case Type', fieldName: 'Case_Type__c',sortable: "true" },
        { label: 'Case Category', fieldName: 'Sub_Category_Type__c',sortable: "true" },
        ...
        { label: 'Assignee', fieldName: 'Case_Assign_User_Name__c',sortable: "true" },
        { label: 'Date Opened', fieldName: 'CreatedDate',sortable: "true" },
        { label: 'Date Closed', fieldName: 'ClosedDate',sortable: "true" },
        { label: 'Case Aging', fieldName: 'Case_Age_Days_del__c',sortable: "true" },
        { label: 'Case Resolution Date', fieldName: 'Case_Resolution_Target_DT__c',sortable: "true" },
        { label: 'SLA Status', fieldName: 'Is_SLA_Crossed__c',sortable: "true" },
        { label: 'Remainging Days untill SLA', fieldName: 'Remaining_Days_Until_SLA__c',sortable: "true" }
