...
import getAccountData from '@salesforce/apex/ats_AccountSearch.getAccountData'; 
import { getPicklistValues } from "lightning/uiObjectInfoApi";
import TYPE_FIELD from "@salesforce/schema/Case.Case_Type__c";
import SUB_CAT from "@salesforce/schema/Case.Sub_Category_Type__c";
import { createRecord } from 'lightning/uiRecordApi';
//metadata class and method
import fetchMetaListLwc from '@salesforce/apex/ats_AccountSearch.fetchMetaListLwc';
//metadata columns
const COLUMNS = [
 ...
 cols = [
  ...
  handleFinish(){
   ...
   // window.setTimeout(function(){location.reload()},3000);
    ...
    //this.handleReset();
    this.childTempVal = true;
    this.childRecID = this.filerecId;
    // this.handleReset();
 ...
 navigateToCaseWorkListTab(){
    ...
    handleSubmit(event) {
       ...
       // alert(fields);
        ...
        console.log("Question"+fields.Question__c);
    } 
    ...
    handleSuccess(event) {
        ...
        this.ncDisabled   = true;
        this.saDisabled   = true;
        this.sabDisabled  = true;
        this.cabDisabled  = true;
    ...
    handleReset(event) {
      ...
      //  window.scrollTo(0,0);
        ...
        this.ncDisabled   = false;
        this.saDisabled   = false;
        this.sabDisabled  = false;
        this.cabDisabled  = false;
   ...
   */
   ...
   /* handleUploadFinished(event) {
    ...
    handleTodoChange(event) {  
        ...
        this.showTableData=false;
        this.typu = "Generic"; 
        this.cat = "Do Not Solicit Non-Member";
        this.Question__c = "*Please include the following information in your case notes: 1) Name that appears on the solicitation 2) Street Address, City, State and Zip Code that appears on the solicitation 3) Is this a second request? Yes/No 4) Phone Number 5) Email Address*";
    }
